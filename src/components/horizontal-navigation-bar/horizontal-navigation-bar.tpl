<md-menu-bar flex>
    <md-menu ng-repeat-start="first in menuList.main track by first.id" ng-if="first.reference">
        <button ng-click="$mdOpenMenu()">{{first.title}}</button>
        <md-menu-content>
            <md-menu-item ng-repeat="second in menuList[first.reference] track by second.id">
                ...
                <md-menu ng-if="second.reference">
                    ...
                    <md-menu-content>
                        <md-menu-item ng-repeat="third in menuList[second.reference] track by third.id">
                            ...
                            <md-menu ng-if="third.reference">
                                ...
                                <md-menu-content>
                                    <md-menu-item ng-repeat="fourth in menuList[third.reference] track by fourth.id">
