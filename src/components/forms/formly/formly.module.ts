...
import multipleAttachmentsWidget from './widgets/multipleattachments/multipleattachments.module';
...
angular.module(moduleName, ['formly', inputWidget, checkboxWidget, radiobuttonWidget,
                    ...
                    multiSelectWidget, lookupWidget, divider, gridMultipleItemsWidget, multipleAttachmentsWidget,
